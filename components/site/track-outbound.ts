...
/**
 * Canonical hostnames for owned cross-property surfaces. Mirrors
 * ``beforeidie/src/lib/normalize.ts::CANONICAL_HOSTNAMES`` and the
 * homepage's track-outbound helper. Keep this list in sync with the
 * data layer - adding a new owned property is a one-line edit there +
 * here, in that order.
 */
