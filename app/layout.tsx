...
export const metadata: Metadata = {
  ...
  description:
    'Open-source orchestrator for parallel AI coding agents. Run Claude Code, Codex, Gemini CLI simultaneously — deterministic scheduling, quality gates, cost tracking. 8,000+ monthly downloads.',
  keywords: [
  ...
  openGraph: {
    ...
    description:
      'Run multiple AI coding agents in parallel on your codebase. Deterministic scheduling. Quality gates. 21 adapters. One command.',
