...
const SITE_DESCRIPTION =
  'The open-source governance layer for AI agents. Runs Claude Code, Codex, Gemini CLI and 40+ agents in parallel git worktrees. No model in the coordination loop, so runs replay byte-identically and a reviewer checks the record offline without rerunning it.';
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title:
      'Bernstein - the open-source governance layer for AI agents',
    description: SITE_DESCRIPTION,
    images: [{ url: '/api/og', width: 1200, height: 630, alt: 'Bernstein - the open-source governance layer for AI agents: Claude Code, Codex, Gemini CLI, and 40+ more, with runs a reviewer can verify offline' }],
  },
  twitter: {
  ...
  return (
    <html lang="en" className={`${fraunces.variable} ${inter.variable} ${jetbrainsMono.variable}`}>
      <head>
        ...
        <link rel="preconnect" href="https://analytics.bernstein.run" crossOrigin="anonymous" />
        ...
        {/* Operator-traffic exclusion - runs synchronously before the
            ...
            operator's own browser console (see
            docs/umami-operator-exclude.md). Real-visitor traffic is
            unaffected because their localStorage flag is unset. */}
        <script
