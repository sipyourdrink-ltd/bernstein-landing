...
const SOFTWARE_APP_JSON_LD = {
  ...
  name: 'Bernstein',
  description:
    'Open-source multi-agent orchestration system for AI coding agents. Coordinates Claude Code, Codex, Gemini CLI, and 20 other agents to work in parallel using deterministic scheduling, git worktree isolation, and quality gates.',
...
const FAQ_JSON_LD = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Bernstein ships 21 adapters: Claude Code, Codex CLI, Gemini CLI, Cursor, Aider, Amp, Roo Code, Kiro, Qwen, Goose, Cody, Continue, Kilo, OpenCode, Tabby, Ollama, and more. A generic adapter lets you wrap any CLI tool.',
      },
    },
    {
      '@type': 'Question',
