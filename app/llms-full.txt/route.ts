...
4. **Agent-agnostic**: Works with any CLI coding agent. Currently ships 37 adapters. Adding a new agent requires implementing a simple adapter interface.
...
| CLI agent support | 37 adapters | No | No | No |
...
Bernstein ships 37 adapters for popular coding agents including Claude Code, Codex CLI, Gemini CLI, OpenAI Agents SDK, Cursor, Aider, Amp, Ollama, GitHub Copilot, Droid, Crush, and more. It also has a generic adapter for wrapping any CLI tool.
