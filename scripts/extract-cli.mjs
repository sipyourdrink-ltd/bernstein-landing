 ...
 * public CLI catalogue pages, so those strings ship: the committed file
 * once carried a `/Users/<name>/.config/bernstein/projects.toml`
 * default, which both names whoever ran the extract and is wrong for
 * every reader.
 *
