...
/** Routes whose page.tsx defines a `const PAGE_DESC = '...'`. */
const STATIC_ROUTES: Array<{ route: string; file: string }> = [
  { route: '/vs', file: 'app/vs/page.tsx' },
  { route: '/why-bernstein', file: 'app/why-bernstein/page.tsx' },
  { route: '/compare', file: 'app/compare/page.tsx' },
  { route: '/sponsors', file: 'app/sponsors/page.tsx' },
  { route: '/benchmarks', file: 'app/benchmarks/page.tsx' },
  {
    route: '/benchmarks/cli-agent-orchestrators',
    file: 'app/benchmarks/cli-agent-orchestrators/page.tsx',
  },
  { route: '/tools/agent-md-bench', file: 'app/tools/agent-md-bench/page.tsx' },
  { route: '/spec-driven', file: 'app/spec-driven/page.tsx' },
  { route: '/cost', file: 'app/cost/page.tsx' },
  { route: '/cli-quickstart', file: 'app/cli-quickstart/page.tsx' },
