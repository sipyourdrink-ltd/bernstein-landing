...
Bernstein needs at least one CLI coding agent installed. The fastest setup uses Claude Code, but [17 agents are supported](https://bernstein.readthedocs.io/en/latest/ADAPTER_GUIDE/) including Codex, Gemini CLI, Aider, and more.
...
- [How Bernstein routes tasks to the right model](/blog/cost-aware-routing): bandit router cuts spend roughly in half in our own runs
