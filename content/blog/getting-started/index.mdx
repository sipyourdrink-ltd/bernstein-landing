...
description: "Install Bernstein, configure an agent, and run your first multi-agent coding session in under 5 minutes. Step-by-step tutorial."
date: "2026-04-14"
...
Bernstein needs at least one CLI coding agent installed. The fastest setup uses Claude Code, but [21 agents are supported](/docs) including Codex, Gemini CLI, Aider, and more.
...
Plans let you define stages, dependencies, roles, and complexity per task. See the [plan file docs](/docs) for the full schema.
