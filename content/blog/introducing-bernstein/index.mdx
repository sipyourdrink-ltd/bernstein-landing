...
description: "Bernstein v1.0 is out. An open-source orchestrator that coordinates multiple CLI coding agents with deterministic scheduling and git isolation."
date: "2026-03-29"
tags: ["announcement", "open-source", "orchestration"]
---
...
## What makes Bernstein different
...
Read the docs: [bernstein.run/docs](/docs)
